...
import { ArrowLeft, Calendar, Coffee, Users } from "lucide-react";
      ...
      <div className="relative h-[60vh] min-h-[450px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-end">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 w-full">
            ...
            <h1 className="font-display text-4xl lg:text-5xl text-ink mb-4">
              {walk.title}
            </h1>
          ...
          {walk.pins.map((pin) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform">
                <p className="text-ink font-medium text-sm">{pin.title}</p>
