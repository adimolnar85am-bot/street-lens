    ...
    <div>
      <div className="bg-white border-b border-line py-16 lg:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-display text-4xl lg:text-6xl text-ink mb-6">
        ...
        <section>
          ...
          <div className="grid gap-6">
            {values.map(({ icon: Icon, title, body }) => (
              <div
                key={title}
                className="p-6 bg-white border border-line rounded-xl"
              >
                <Icon className="w-6 h-6 text-scarlet mb-3" />
