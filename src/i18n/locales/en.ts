...
const en: DeepStringify<typeof ro> = {
  ...
  hero: {
    eyebrow: "Street Photography Community",
    title1: "We capture the city,",
    title2: "together.",
    body: "We meet every Saturday for photowalks with themes chosen by the community. Digital, analog, or phone — every format is welcome.",
    ctaWalk: "Next photowalk",
  ...
  formats: {
    eyebrow: "Formats",
    title: "Three ways to see the street",
    body: "Whatever your gear, our community celebrates personal vision. Explore resources for each format.",
    explore: "Explore",
    digital: {
  ...
  photowalks: {
    eyebrow: "Photowalks",
    title1: "Every Saturday,",
    title2: "a new theme",
    body: "The community picks the theme each week. We meet, shoot for 2–3 hours, then document the route on the interactive map.",
